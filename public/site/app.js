...
(function (TSAGame) {
    var Preloader = (function (_super) {
        ...
        Preloader.prototype.create = function () {
            var _this = this;
            this.add.tween(this.preloadBar).to({ alpha: 0 }, 1000, Phaser.Easing.Linear.None, true).onComplete.add(function () { return _this.game.state.start("MainMenu", true, false); });
        };
        return Preloader;
    }(Phaser.State));
...
(function (TSAGame) {
    var MainMenu = (function (_super) {
        ...
        MainMenu.prototype.fadeOut = function () {
            ...
            this.add.tween(this.logo).to({ y: this.logo.height / 2 }, 2000, Phaser.Easing.Bounce.Out, true).onComplete.add(function () {
