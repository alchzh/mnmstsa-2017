namespace TSAGame {
    ...
    export class MainMenu extends Phaser.State {
        ...
        create() {
            ...
            let bot = (this.logo.height + 800 - this.logo.width) / 2;
            this.add.tween(this.logo).to({ y: bot}, 1500, Phaser.Easing.Elastic.Out, true, 1000).onComplete.add(() => {
                this.team = this.add.text(400, bot / 2 + this.logo.height / 4 + 300, "1043-901", {font: "bold 56px Arial", fill: "#fff"});
